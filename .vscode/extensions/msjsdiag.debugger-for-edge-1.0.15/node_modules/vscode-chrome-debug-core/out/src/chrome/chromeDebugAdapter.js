    ...
    onScriptParsed(script) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const sourceMapsP = this._sourceMapTransformer.scriptParsed(mappedUrl, script.url, script.sourceMapURL).then((sources) => __awaiter(this, void 0, void 0, function* () {
                    if (this._hasTerminated) {
                        return undefined;
                    }
                    if (sources) {
    ...
    */
    stackTrace(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            stackTraceResponse.stackFrames.forEach(frame => {
                remoteMapper_1.mapInternalSourceToRemoteClient(frame.source, this._launchAttachArgs.remoteAuthority);
            });
    ...
    scriptToSource(script) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            remoteMapper_1.mapInternalSourceToRemoteClient(source, this._launchAttachArgs.remoteAuthority);
            return source;
        });
    }
